...
from eval_tuned_model import eval_fine_tuned
...
#         metrics='ppl,d_1')
    ...
    # NOTE: I think this is evaluating on the validation set.
...
#         model='tuning_evaluation:TransformerAgent')
    ...
    print(opt)
    report = eval_fine_tuned(opt, build_dict=build_dict)#, print_parser)
    
    print('REPORT:', report)
#     print('FINAL Hits@1: ' + str(report['hits@1']))
#     print('FINAL ppl: ' + str(report['ppl']))
